...
describe("database migration graph", () => {
    ...
    test("applies the reviewed migration graph to an empty database", async () => {
        ...
        for (const trigger of [
            ...
            "chat_external_runtime_snapshots_reject_identity_update",
            "chat_external_runtime_snapshots_reject_replace",
            "chat_external_runtime_snapshots_validate_capacity_insert",
            "chat_external_runtime_snapshots_validate_capacity_update",
            "chat_external_runtime_snapshots_validate_current_insert",
            "chat_external_runtime_snapshots_validate_monotonic_update",
