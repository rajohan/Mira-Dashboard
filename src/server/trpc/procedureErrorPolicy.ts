...
export const procedureExpectedErrorPolicy = freezeProcedureExpectedErrorPolicy({
    ...
    "delivery.listPullRequests": ["FORBIDDEN", "SERVICE_UNAVAILABLE", "UNAUTHORIZED"],
    "delivery.listDeployments": ["FORBIDDEN", "SERVICE_UNAVAILABLE", "UNAUTHORIZED"],
    "delivery.getPreview": ["FORBIDDEN", "SERVICE_UNAVAILABLE", "UNAUTHORIZED"],
    "delivery.getProductionCheckout": [
        "FORBIDDEN",
        "SERVICE_UNAVAILABLE",
        "UNAUTHORIZED",
    ],
    "delivery.getReleases": ["FORBIDDEN", "SERVICE_UNAVAILABLE", "UNAUTHORIZED"],
    ...
    "backups.getKopiaStatus": ["FORBIDDEN", "UNAUTHORIZED"],
    "backups.getWalgStatus": ["FORBIDDEN", "UNAUTHORIZED"],
    ...
    "system.documentationReference": ["FORBIDDEN", "UNAUTHORIZED"],
