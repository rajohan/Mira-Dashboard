...
/** Canonical zero-state application projection for host-only browser fixtures. */
export const unavailableSystemApplicationMetrics = {
 ...
 * @returns Canonical fully observed application metrics for browser rendering tests.
 */
export function observedSystemApplicationMetrics(
    sampledAtMs: number
