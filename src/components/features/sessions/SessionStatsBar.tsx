...
export function SessionStatsBar({
    ...
    return (
        <div className="grid flex-shrink-0 grid-cols-3 border-b border-primary-700 bg-primary-800/30 py-4">
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="max-w-[150px] truncate text-sm font-medium text-primary-200">
                        {model}
                    </p>
                </div>
            </div>
