 ...
 * @param repoDirectory Repo directory value.
 * @returns a full release commit only for a clean source tree. Dirty builds stay usable for local verification but cannot be accepted by release:manifest.
 */
