...
const dopplerArguments = Object.freeze([
    ...
    "prd",
    "--only-secrets",
    "OPENCLAW_GATEWAY_TOKEN,MOLTBOOK_API_KEY,ELEVENLABS_API_KEY,RESEND_API_KEY,MIRA_DASHBOARD_RESEND_FROM_EMAIL,MIRA_DASHBOARD_SESSION_IDLE_MINUTES,MIRA_DASHBOARD_RECENT_AUTH_MINUTES",
