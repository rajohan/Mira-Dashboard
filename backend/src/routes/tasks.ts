...
/** Describes cron list response. */
interface CronListResponse {
    jobs?: CronJob[];
    items?: CronJob[];
}

/** Describes task automation input. */
...
/** Handles normalize automation input. */
...
/** Handles to frontend automation. */
...
/** Handles to frontend task update. */
