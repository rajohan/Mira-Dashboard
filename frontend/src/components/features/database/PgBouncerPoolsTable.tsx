...
const columnHelper =
    createColumnHelper<DatabaseOverviewResponse["pgbouncerPools"][number]>();
 ...
 * @returns Rendered the pg bouncer pools table UI.
 */
export function PgBouncerPoolsTable({
    data,
}: {
    data: DatabaseOverviewResponse["pgbouncerPools"];
}) {
