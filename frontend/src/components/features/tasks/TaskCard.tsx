 ...
 * @returns Rendered the task card UI.
 */
    ...
    return (
        ...
        >
            <button
                ...
                className="absolute top-1/2 left-1.5 z-20 -translate-y-1/2 cursor-grab rounded text-primary-500 transition-opacity hover:text-primary-300 focus:opacity-100 focus:ring-2 focus:ring-accent-400 focus:outline-none md:text-primary-600 md:opacity-0 md:group-hover:opacity-100"
            ...
            <button
                ...
                className="peer absolute inset-0 rounded-lg focus:outline-none"
                onClick={onClick}
            />
            <div className="pointer-events-none relative z-10 min-w-0 pl-3">
                ...
                <h3 className="mb-1.5 line-clamp-2 text-sm font-medium wrap-break-word text-primary-200">
                    {task.title}
                </h3>
