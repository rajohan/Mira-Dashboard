 ...
 * @returns Rendered the sessions table UI.
 */
export function SessionsTable({
    ...
    const columns = [
        columnHelper.accessor("type", {
             ...
             * @returns Rendered the formatted session type badge.
             */
            cell: (info) => (
             ...
             * @param a A value.
             * @param b B value.
             * @returns Sorted session types by the dashboard's preferred type order.
             */
            sortingFn: (a, b) => {
        ...
        columnHelper.accessor(
            (row) => row.displayLabel || row.label || row.displayName || row.id,
            {
                 ...
                 * @param info Info value.
                 * @returns Rendered the best available session display name.
                 */
                cell: (info) => (
        ...
        columnHelper.accessor("model", {
             ...
             * @param info Info value.
             * @returns Rendered the model name fallback for sparse session rows.
             */
            cell: (info) => (
        ...
        columnHelper.accessor("tokenCount", {
             ...
             * @param info Info value.
             * @returns Rendered token usage text and progress for the session row.
             */
            cell: (info) => {
        ...
        columnHelper.accessor("updatedAt", {
             ...
             * @param info Info value.
             * @returns Rendered the relative session activity age.
             */
            cell: (info) => (
        ...
        columnHelper.display({
             ...
             * @returns Rendered the row action menu without selecting the row.
             */
            cell: ({ row }) => (
