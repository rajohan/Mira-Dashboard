 ...
 * @param rawCommand Raw command value.
 * @returns Slash command canonical name result.
 */
 ...
 * @param draft Draft value.
 * @param chatModelOptions Chat model options value.
 * @returns Built slash command suggestions.
 */
