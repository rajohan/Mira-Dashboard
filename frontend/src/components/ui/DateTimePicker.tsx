...
const calendarClassNames = {
    ...
    [UI.DayButton]: cn(
        ...
        "transition-colors focus-visible:ring-2 focus-visible:ring-accent-400 focus-visible:outline-none hover:enabled:bg-primary-700!"
    ),
 ...
 * @returns Rendered a localized calendar with an explicit 24-hour time selector.
 */
export function DateTimePicker({
    ...
    return (
        ...
        >
            <legend className="mb-1 text-sm font-medium text-primary-300">{label}</legend>
            <div
