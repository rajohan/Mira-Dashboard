 ...
 * @returns Rendered the select UI.
 */
    ...
    return (
        ...
        >
            ...
            <MenuItems
                ...
                className={cn(
                    "z-70 max-h-60 max-w-[min(36rem,calc(100vw-2rem))] min-w-(--button-width) overflow-y-auto rounded-lg border border-primary-700 bg-primary-900 shadow-xl ring-1 shadow-black/30 ring-black/20 outline-none",
                    menuWidth || "w-max"
                )}
            >
                {options.map((option) => (
