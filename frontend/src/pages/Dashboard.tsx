...
/**
 * Renders the weather icon matching the current conditions.
 * @param description Description value.
 * @param className Class name value.
 * @returns Rendered the weather icon matching the current conditions.
 */
function renderWeatherIcon(description?: string, className = "size-7 text-amber-300") {
 ...
 * @returns Formatted temp for display.
 */
 ...
 * @returns Rendered the weather time card UI.
 */
        ...
        <Card className={className}>
            ...
            <div className="mt-3 grid grid-cols-3 gap-1 sm:gap-2 xl:grid-cols-1 2xl:grid-cols-3">
                {(weather?.forecast || []).slice(0, 3).map((day, index) => {
                    ...
                    const forecastIcon = renderWeatherIcon(
                        day.description,
 ...
 * @returns Rendered the dashboard UI.
 */
export function Dashboard() {
    ...
    return (
        <div className="space-y-4 p-3 sm:p-4 lg:space-y-6 lg:p-6">
            ...
            <AppObservabilityCard metrics={metrics} />
