 ...
 * @param publicOrigin Public origin value.
 * @returns Validation result for the external origin at startup and falls back to each local request URL.
 */
 ...
 * @returns Development cookie header result.
 */
