 ...
 * @returns Whether a transition matches the latest short-lived rotation signal. Its first match binds that signal to the exact replacement session.
 */
 ...
 * @returns Promise resolving to the recover or handle unauthorized session result.
 */
