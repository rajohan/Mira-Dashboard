...
/**
 * Applies the shared Effect deadline policy used by this qualification slice.
 * @param effect Operation governed by the qualification deadline.
    ...
    const close = Effect.sync(() => {
        if (
            ...
            try {
                ...
                observer.socket.close(1000, "qualification scope closed");
            } catch {
...
> {
    return Effect.acquireUseRelease(
        ...
        (listener) => Effect.succeed(`ws://127.0.0.1:${listener.port}/qualification`),
