CREATE TABLE `users` (
	...
	CONSTRAINT "users_username_check" CHECK(length("username") BETWEEN 3 AND 32 AND "username" = lower("username") AND substr("username", 1, 1) GLOB '[a-z0-9]' AND "username" NOT GLOB '*[^a-z0-9._-]*')
) STRICT;
