...
| `@simplewebauthn/server` | `13.3.3` | `13.3.3` | runtime |
| `@tailwindcss/typography` | `^0.5.20` | `0.5.20` | runtime |
| `@tanstack/query-core` | `5.102.8` | `5.102.8` | runtime |
| `@tanstack/query-db-collection` | `1.2.11` | `1.2.11` | runtime |
| `@tanstack/react-db` | `0.3.6` | `0.3.6` | runtime |
| `@tanstack/react-form` | `^1.33.5` | `1.33.5` | runtime |
| `@tanstack/react-query` | `^5.102.8` | `5.102.8` | runtime |
| `@tanstack/react-router` | `^1.170.32` | `1.170.32` | runtime |
| `@tanstack/react-store` | `0.11.1` | `0.11.1` | runtime |
| `@tanstack/react-table` | `^9.2.3` | `9.2.3` | runtime |
...
| `effect` | `4.0.0-rc.112` | `4.0.0-rc.112` | runtime |
| `json5` | `^2.2.3` | `2.2.3` | runtime |
| `lucide-react` | `1.35.0` | `1.35.0` | runtime |
...
| `@happy-dom/global-registrator` | `^20.11.12` | `20.11.12` | development |
| `@storybook/addon-a11y` | `10.6.0-beta.0` | `10.6.0-beta.0` | development |
| `@storybook/addon-docs` | `10.6.0-beta.0` | `10.6.0-beta.0` | development |
| `@storybook/addon-vitest` | `10.6.0-beta.0` | `10.6.0-beta.0` | development |
| `@storybook/tanstack-react` | `10.6.0-beta.0` | `10.6.0-beta.0` | development |
...
| `@testing-library/react` | `^16.3.3` | `16.3.3` | development |
| `@testing-library/user-event` | `14.6.6` | `14.6.6` | development |
| `@types/node` | `26.4.0` | `26.4.0` | development |
| `@types/react` | `^19.2.18` | `19.2.18` | development |
| `@types/react-dom` | `^19.2.5` | `19.2.5` | development |
| `@types/react-syntax-highlighter` | `^15.5.13` | `15.5.13` | development |
| `@typescript-eslint/scope-manager` | `8.68.0` | `8.68.0` | development |
...
| `eslint-plugin-storybook` | `10.6.0-beta.0` | `10.6.0-beta.0` | development |
| `eventsource` | `5.1.1` | `5.1.1` | development |
| `happy-dom` | `^20.11.12` | `20.11.12` | development |
| `lcov-result-merger` | `^6.0.0` | `6.0.0` | development |
| `lefthook` | `2.1.12` | `2.1.12` | development |
| `oxc-parser` | `0.147.0` | `0.147.0` | development |
| `oxfmt` | `^0.65.0` | `0.65.0` | development |
| `oxlint` | `1.80.0` | `1.80.0` | development |
...
| `storybook` | `10.6.0-beta.0` | `10.6.0-beta.0` | development |
