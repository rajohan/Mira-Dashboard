...
- The living inventory is now **113 implemented, 41 planned, and three reviewed removals** out of
  157 legacy endpoints. Browser routes are **13 implemented and three planned**. This advances
  Phase 5 without claiming complete exec, host-operation, Docker/delivery or database
