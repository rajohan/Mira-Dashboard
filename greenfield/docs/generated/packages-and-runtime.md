...
| `@tanstack/react-router` | `^1.170.29` | `1.170.29` | runtime |
...
| `effect` | `^4.0.0-rc.110` | `4.0.0-rc.110` | runtime |
| `json5` | `^2.2.3` | `2.2.3` | runtime |
| `lucide-react` | `1.32.0` | `1.32.0` | runtime |
...
| `@storybook/addon-a11y` | `^10.6.0-alpha.6` | `10.6.0-alpha.6` | development |
| `@storybook/addon-docs` | `^10.6.0-alpha.6` | `10.6.0-alpha.6` | development |
| `@storybook/addon-vitest` | `^10.6.0-alpha.6` | `10.6.0-alpha.6` | development |
| `@storybook/tanstack-react` | `^10.6.0-alpha.6` | `10.6.0-alpha.6` | development |
| `@tailwindcss/vite` | `4.3.3` | `4.3.3` | development |
| `@tanstack/react-devtools` | `^0.10.10` | `0.10.10` | development |
| `@tanstack/react-form-devtools` | `^0.2.34` | `0.2.34` | development |
...
| `eslint-plugin-react-you-might-not-need-an-effect` | `^1.0.1` | `1.0.1` | development |
| `eslint-plugin-storybook` | `^10.6.0-alpha.6` | `10.6.0-alpha.6` | development |
...
| `oxfmt` | `^0.63.0` | `0.63.0` | development |
| `oxlint` | `^1.78.0` | `1.78.0` | development |
| `oxlint-config-presets` | `^0.1.19` | `0.1.19` | development |
| `oxlint-tailwindcss` | `^1.9.0` | `1.9.0` | development |
| `oxlint-tsgolint` | `^7.0.2001` | `7.0.2001` | development |
| `playwright` | `1.62.1` | `1.62.1` | development |
| `storybook` | `^10.6.0-alpha.6` | `10.6.0-alpha.6` | development |
