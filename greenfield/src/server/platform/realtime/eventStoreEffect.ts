...
export class RealtimeEventStoreBusyError extends TaggedErrorClass<RealtimeEventStoreBusyError>(
...
export class RealtimeEventStoreUnavailableError extends TaggedErrorClass<RealtimeEventStoreUnavailableError>(
