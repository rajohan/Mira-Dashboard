...
export class RenewableStreamLeaseTimeoutError extends TaggedErrorClass<RenewableStreamLeaseTimeoutError>(
...
export class RenewableStreamLeaseInvalidError extends TaggedErrorClass<RenewableStreamLeaseInvalidError>(
