...
async function procedureContractsFor(
    ...
    switch (domain) {
        ...
        case "delivery": {
            const module = await import("../../contracts/delivery.ts");
            return module.deliveryProcedureContracts;
        }
        case "docker": {
        ...
        case "schedules": {
            const module = await import("../../contracts/schedules.ts");
            return module.scheduleProcedureContracts;
        }
        ...
        case "serviceActions": {
            const module = await import("../../contracts/serviceActions.ts");
            return module.serviceActionProcedureContracts;
        }
        case "system": {
